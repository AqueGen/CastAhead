...
Everything lives in the addon window, next to the cast table. **General** holds the eight switches for what gets announced, plus icon placement and the centre call's position; **Sounds** lets you pick any sound your other addons registered, per category, and a different one for any single spell (Add spell... at the bottom; a spell's own pick wins over its category's).
