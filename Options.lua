...
function BuildGeneral(panel)
    ...
    strataDropdown:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("Where the icons draw among other frames. HIGH sits above every nameplate and the normal UI but under popups and this window; pick DIALOG or higher only if a nameplate addon lifts its plates above HIGH.", nil, nil, nil, true)
        GameTooltip:Show()
    end)
