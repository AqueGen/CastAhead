...
function BuildGeneral(panel)
    ...
    strataDropdown:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("Where the icons draw among other frames. DIALOG sits above every nameplate addon's frames but also above popups; pick lower to stay under dialogs, higher if a nameplate addon lifts its plates above DIALOG.", nil, nil, nil, true)
        GameTooltip:Show()
    end)
